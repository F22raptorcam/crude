...
<center>	<a title="Home" href="index.php" class="nav-link"></a></li>	
	...
	?>
   	<div class="container">
		<h1><a style="color:blue">NMB BANK EMPLOYEES</a></h1>
		<div class="card">
			<div class="card-header"><i class="fa fa-fw fa-globe"></i> <strong>EMPLOYEES PANNEL</strong> <a href="add-users.php" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-plus-circle"></i> ADD EMPLOYEES</a></div>
			<div class="card-body">
				<?php
						...
						<div class="row">
							<div class="col-sm-2">
								<div class="form-group">
									...
									<input type="text" name="playername" id="playername" class="form-control" value="<?php echo isset($_REQUEST['playername'])?$_REQUEST['playername']:''?>" placeholder="">
								</div>	
							</div>
							<div class="col-sm-2">
								<div class="form-group">
									<label>I D    number  .</label>
									<input type="text" name="positionplay" id="positionplay" class="form-control" value="<?php echo isset($_REQUEST['positionplay'])?$_REQUEST['positionplay']:''?>" placeholder="">
								</div>
							</div>
							<div class="col-sm-2">
								<div class="form-group">
									<label>Phone  number .</label>
									<input type="text" name="jerserynumber" id="jerserynumber" class="form-control" value="<?php echo isset($_REQUEST['jerserynumber'])?$_REQUEST['jerserynumber']:''?>" placeholder="">
								</div>
							</div>
							<!-- <div class="col-sm-4">
							...
							<div class="col-sm-2">
								<div class="form-group">
									...
									<div>
										...
										<a href="<?php echo $_SERVER['PHP_SELF'];?>" style=" margin-left: 100px;margin-top: -67px;width: 6em;" class="btn btn-danger"><i class="fa fa-fw fa-sync"></i> </a>
									</div>
								</div>
							</div>
						</div>
		...
		<div>
			<table class="table table-striped table-bordered">
				...
				<tbody>
					...
					?>
					<tr><td colspan="6" align="center">Employee not found</td></tr>
					<?php } ?>
				</tbody>
			</table>
		</div> <!--/.col-sm-12-->
