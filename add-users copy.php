...
if(isset($_REQUEST['submit']) and $_REQUEST['submit']!=""){
	...
	if($playername==""){
		...
		$userCount	=	$db->getQueryCount('user','id');
		$data	=	array(
		...
		if($insert){
			header('location:browse-users copy.php?msg=ras');
		
			exit;
		}else{
			header('location:browse-users copy.php?msg=rna');
				...
				<nav class="navbar navbar-expand-lg navbar-light bg-light"> <a class="navbar-brand text-muted p-0 m-0" href="https://learncodeweb.com"><img src='https://learncodeweb.com/wp-content/uploads/2019/01/logo.png' alt='LearnCodeWeb'></a>
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						...
						<ul class="navbar-nav mr-auto">
							...
							<li itemscope="itemscope" id="menu-item-17" class="active nav-item"><a title="Home" href="browse-users.php" class="nav-link">Home</a></li>
...
<!-- 
	...
	<div class="container my-4">
   	...
   	<div class="container">
		...
		<h1><a href="https://learncodeweb.com/php/php-crud-in-bootstrap-4-with-search-functionality/" style="color:red"> MANCHESTER UNITED FOOTBALL CLUB SINCE 1878</a></h1>
				...
				<div class="col-sm-6">
					...
					<form method="post">
						...
						<div class="form-group">
							...
							<label>Player position <span class="text-danger">*</span></label>

							<input type="text" name="positionplay" id="positionplay" class="form-control" placeholder="Enter player position" required>

						</div>	

						<div class="form-group">

							<label>Player Jersery <span class="text-danger">*</span></label>
<br>
							<input type="text" name="jerserynumber" id="jerserynumber" x-autocompletetype="tel" placeholder="Enter jerserynumber" required>

						</div>

						<div class="form-group">

							<button type="submit" name="submit" value="submit" id="submit" class="btn btn-primary"><i class="fa fa-fw fa-plus-circle"></i> Add Player</button>
